...
- **Follow a skill's procedure and output format strictly; make improvements permanent by updating the skill.** Don't just save behavioral improvements to memory temporarily — update the skill body itself. When you write or edit a skill, review it with `skill-review` before committing.
