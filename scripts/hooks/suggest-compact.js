...
async function main() {
  ...
  const sessionId = process.env.CLAUDE_SESSION_ID || process.env.CODEX_THREAD_ID || process.ppid || 'default';
  const counterFile = path.join(getTempDir(), `agent-tool-count-${sessionId}`);
